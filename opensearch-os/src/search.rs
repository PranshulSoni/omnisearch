...
static QUICK_ACTIONS: &[QuickAction] = &[
    ...
    QuickAction { triggers: &["check for updates", "check for extension updates"], name: "Check for Updates", breadcrumb: "Settings & Management > Check for Updates", launch_command: "https://github.com/PranshulSoni/Project-Raycast", description: "Check GitHub repository for new releases." },
